const data = [
	...
	},
	{
		id: 8,
		name: "Bhopal",
		info: "Bhopal is known as city of lakes, tourist places near bhopal Bhojpur, Bheembetika, Sanchi , Islamnagar, Samasgarh, etc. are worth a visit. The city is a blend of old and modern architecture.There are many places for tourists in Bhopal like Upper Lake, lower lake, Birla Temple, Van Vihar, Bharat Bhavan, Indira Gandhi National Museum of Man, Manu Bhaun ki tekari, cave temples, the Taj-ul-Masjid, Jama Masjid, Gauhar Mahal, Shaukat Mahal, Regional Science Centre, Fish aquarium, Kerwa dam etc.",
		image: "https://as1.ftcdn.net/v2/jpg/04/73/45/68/1000_F_473456829_OtAjHyQQs8eXxagx8SCIo9m0rBqIbIoz.jpg",
		price: "79,995",
	},
];
